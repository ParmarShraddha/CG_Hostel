...
class _LoginWithPhoneState extends State<LoginWithPhone> {
  ...
  var firebaseDatabase = FirebaseDatabase.instance.ref("Girls");
            ...
            ElevatedButton(onPressed: ()async {
              ...
              await _firebaseAuth.signInWithCredential(credentialUse).then((value) async{
                ...
                if (temp1.containsKey(value.user!.uid)){
                  ...
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => studentHome(userToken: value.user!.uid.toString(),)));
                }
                else{
                  ...
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => studentHome(userToken: value.user!.uid,),));
                }
